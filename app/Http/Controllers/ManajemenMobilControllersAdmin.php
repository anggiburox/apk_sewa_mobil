...
class ManajemenMobilControllersAdmin extends Controller
{
    /**
    ...
    {   
        ...
        return view('pages/admin/manajemen_mobil/index',['pgw' => $pgw]);
    }

	
    public function tambah(){
        return view('pages/admin/manajemen_mobil/tambah', []);
    }
	...
	return redirect('/admin/manajemen_mobil/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/admin/manajemen_mobil/edit',['pgw' => $pgw]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman ManajemenMobil
		return redirect('/admin/manajemen_mobil')->withSuccess('Data berhasil diperbaharui');
    }
    ...
    $mobil = DB::table('manajemen_mobil')->where('ID_Mobil', $id)->first();
        ...
        if ($mobil) {
            ...
            return redirect('/admin/manajemen_mobil')->withDanger('Data berhasil dihapus');
        }
	}
