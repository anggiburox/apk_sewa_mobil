...
class PeminjamanMobilControllersAdmin extends Controller
{
    /**
    ...
    {   
        $pgw = PeminjamanMobilModel::peminjammobiljoin();
        return view('pages/admin/peminjaman_mobil/index',['pgw' => $pgw]);
    }
    ...
    public function tambah(){
        ...
        return view('pages/admin/peminjaman_mobil/tambah', ['mobil'=>$mobil, 'pengguna'=>$pengguna]);
    }
	...
	return redirect('/admin/peminjaman_mobil/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/admin/peminjaman_mobil/edit',['pgw' => $pgw,'mobil'=>$mobil,'pengguna'=>$pengguna]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman ManajemenMobil
		return redirect('/admin/peminjaman_mobil')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function hapus($id){
		...
		return redirect('/admin/peminjaman_mobil')->withDanger('Data berhasil dihapus');
	}
