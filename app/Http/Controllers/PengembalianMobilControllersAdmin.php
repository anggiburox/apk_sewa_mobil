...
class PengembalianMobilControllersAdmin extends Controller
{
    /**
    ...
    {   
        $pgw = PengembalianModel::pengembalianjoin();
        return view('pages/admin/pengembalian_mobil/index',['pgw' => $pgw]);
    }

	
    public function tambah(){
		$peminjaman = PeminjamanMobilModel::peminjammobiljoinTidakTersedia();
        return view('pages/admin/pengembalian_mobil/tambah', ['peminjaman'=>$peminjaman]);
    }
	...
	return redirect('/admin/pengembalian_mobil/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
	{
		...
		return view('pages/admin/pengembalian_mobil/edit',['pgw' => $pgw,'mobil'=>$mobil,'pengguna'=>$pengguna]);
	}
	...
	public function update(Request $request){
		...
		// alihkan halaman ke halaman ManajemenMobil
		return redirect('/admin/pengembalian_mobil')->withSuccess('Data berhasil diperbaharui');
    }
	...
	public function hapus($id){
		...
		return redirect('/admin/pengembalian_mobil')->withDanger('Data berhasil dihapus');
	}
