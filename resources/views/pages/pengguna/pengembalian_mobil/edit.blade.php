                    ...
                    {{ csrf_field() }}
                        ...
                        <div class="row mb-3">
                            <label for="inputText" class="col-sm-3 col-form-label">Tangal Mulai <label
                                    style='color:red;'>(*)</label></label>
                            <div class="col-sm-2">
                                <input type="date" class="form-control" name="tanggal_mulai" required value="{{$pp->Tanggal_Mulai}}">
                            </div>
                            <label for="inputText" class="col-sm-3 col-form-label">Tanggal Selesai<label
                                    style='color:red;'>(*)</label></label>
                            <div class="col-sm-2">
                                <input type="date" class="form-control" name="tanggal_selesai" required value="{{$pp->Tanggal_Selesai}}">
                            </div>
                        </div>
                        <div class="col-12">
