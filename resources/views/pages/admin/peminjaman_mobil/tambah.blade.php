...
<div class="pagetitle">
    <div class="card">
        <div class="card-title card-body">
            <h2 class='mt-3 text-black'>Tambah Data Peminjaman Mobil</h2>
        </div>
    </div>
</div>
<!-- End Page Title -->
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/peminjaman_mobil/store" method="POST" id='form-submit' enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-2">
                                <select name='id_pengguna' id="selectPengguna" class='form-control' onchange=showPengguna() required>
                                    ...
                                    <option value="{{ $p->ID_Pengguna }}"
                                        ...
                                        {{ $p->Nama_Pengguna}} - {{$p->Nomor_SIM_Pengguna}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
