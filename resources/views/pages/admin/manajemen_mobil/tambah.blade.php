...
<div class="pagetitle">
    <div class="card">
        <div class="card-title card-body">
            <h2 class='mt-3 text-black'>Tambah Data Manajemen Mobil</h2>
        </div>
    </div>
</div>
<!-- End Page Title -->
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/manajemen_mobil/store" method="POST" id='form-submit' enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="inputText" class="col-sm-3 col-form-label">Tarif Sewa Harga<label
                                    style='color:red;'>(*)</label></label>
                            <div class="col-sm-5">
                                <input type="number" min='0' class="form-control" name="tarif_sewa" required>
                            </div>
                        </div>
                        <div class="row mb-3">
