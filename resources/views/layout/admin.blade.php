...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/pengguna">
                    <i class="bi bi-person text-black"></i>
                    <span class='text-black'>Pengguna</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/manajemen_mobil">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/peminjaman_mobil">
                    <i class="bi bi-car-front text-black"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/admin/pengembalian_mobil">
                    <i class="bi bi-car-front text-black"></i>
